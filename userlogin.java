	...
	*/
	...
	public class userlogin extends Applet implements ActionListener, KeyListener{
	...
	public boolean login(String user, String pass) throws SQLException
	{
		...
		try {
		 ...
		 stmt = con.createStatement();
		        ResultSet rs = stmt.executeQuery("Select password from candidates WHERE "+user+" = email");
	...
	public void checklogin(String user, String pass) throws HeadlessException, SQLException{
